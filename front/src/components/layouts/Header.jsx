        ...
        <header>
            <div class="mobile-plan-banner -container">
                    ...
                    <div id="" class="mobile-plan-banner -banner-offer-text" data-uia="">
                      ...
                      <span class="mobile-plan-banner -price-label">5,99&nbsp;€</span>.</span>/mois
                    </div>
                    <div
                      class="mobile-plan-button-cta btn-small --alternate-cta-treatment">
                      <a
                        data-uia="ad_plan_banner"
                        class="btn btn-outline btn-small"
                        href="/signup"
                        target="_top">En savoir plus<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="button-icon icon-chevron-next">
                          <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
                  ...
                  <div class="our-story-header-wrapper">
                    <div class="our-story-header our-story-header--has-language-selector" data-uia-nmhp="our-story-header" >
                      ...
                      <div class="lang-selection-container" id="lang-switcher">
                        ...
                        >
                          <label
                            for="lang-switcher-header-select"
                            class="ui-label"
