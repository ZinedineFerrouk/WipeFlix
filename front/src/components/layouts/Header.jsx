...
const Header = () => {
	...
	return (
        <header>
            <div className="mobile-plan-banner -container">
                    <div className="badging-indicator">Nouveau&nbsp;!</div>
                    <div id="" className="mobile-plan-banner -banner-offer-text" data-uia="">
                      <span>Offres désormais disponibles à partir de
                      <span className="mobile-plan-banner -price-label">5,99&nbsp;€</span>.</span>/mois
                    </div>
                    <div
                      className="mobile-plan-button-cta btn-small --alternate-cta-treatment">
                      <Link
                        data-uia="ad_plan_banner"
                        className="btn btn-outline btn-small"
                        to="/"
                        target="_top">En savoir plus<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="button-icon icon-chevron-next">
                          <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                  ...
                  <div className="our-story-header-wrapper">
                    <div className="our-story-header our-story-header--has-language-selector" data-uia-nmhp="our-story-header" >
                      ...
                      <div className="lang-selection-container" id="lang-switcher">
                        ...
                        >
                          <label
                            htmlFor="lang-switcher-header-select"
                            className="ui-label"
